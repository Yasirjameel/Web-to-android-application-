...
public class vipgames extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       // return inflater.inflate(R.layout.guessingform,null);
        View rootView = inflater.inflate(R.layout.vipgames, container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mywebview.loadUrl("http://sattamatkaresults.today/vip.php");
